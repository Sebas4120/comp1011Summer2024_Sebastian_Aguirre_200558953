...
public class WEEK10 {
    ...
    static void jsonPart1 (){
        ...
        In Java we can work with the library called : GSON
                */
...
//        String sampleData = "{\"hi\", \"there\", \"everyone\", 'A', 1, 2.2}";
//        Gson gson = new Gson();

//        gson.fromJson(sampleData, String.class);
